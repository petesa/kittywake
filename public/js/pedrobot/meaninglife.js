...
(lib.Text_ftw1 = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Lager 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#767676").s().p("");
	this.shape.setTransform(206.4,12.8);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#767676").s().p("AAUBOQgDgDAAgEIAAgfIhAAAQgFgBgEgDQgDgDAAgFQAAgEACgCIA+heQADgEADgCQAEgCAFAAQAHAAAFAFQAFAFAAAHIAABVIAPAAQADAAADACQACADAAAEQAAAEgCACQgDACgDABIgPAAIAAAfQAAAEgDADQgDADgEAAQgEAAgDgDgAgmAWIA3AAIAAhSg");
	this.shape_1.setTransform(193,13);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.Text_ftw1, new cjs.Rectangle(0,0,400,28), null);


(lib.hitchhiker = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});

	// Lager 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#000000").s().p("AhECOIAAiCIANgBQAVAAAAgVQAAgjAagVQAYgVAAgOIAAgNQAAgMAIgIQAIgHAMAAQALABAHAIQAHAIAAALIAAAiQAAARgXAVQgYAUAAAYIAABeQAAATgNANQgMANgSAAg");
	this.shape.setTransform(-4.5,0);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000000").s().p("AgTAbQgLgBgHgHQgIgIAAgLQAAgKAIgHQAHgJALABIAnAAQALgBAHAJQAIAHAAAKQAAALgIAIQgHAHgLABg");
	this.shape_1.setTransform(4,11.1);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#000000").s().p("AgaAaQgLAAgHgIQgIgHAAgLQAAgKAIgIQAHgHALgBIA0AAQALABAIAHQAIAIAAAKQAAALgIAHQgIAIgLAAg");
	this.shape_2.setTransform(4.7,5.9);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#000000").s().p("AghAaQgLABgHgJQgIgHAAgLQAAgKAIgIQAHgIALAAIBCAAQALAAAIAIQAIAIAAAKQAAALgIAHQgIAJgLgBg");
	this.shape_3.setTransform(5.4,0.6);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.hitchhiker, new cjs.Rectangle(-11.4,-14.1,22.8,28.4), null);


(lib.Subtitles_ftw = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Text1
	this.instance = new lib.Text_ftw1();
...
// stage content:
(lib.meaninglife = function(mode,startPosition,loop) {
	this.initialize(mode,startPosition,loop,{});
	...
	// Subtitles
	this.instance = new lib.Subtitles_ftw();
	...
	// Emoji
	this.instance_1 = new lib.hitchhiker();
	this.instance_1.parent = this;
	this.instance_1.setTransform(268,113.3);
	this.instance_1._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(22).to({_off:false},0).wait(1).to({scaleX:1.21,scaleY:1.21},0).wait(1).to({scaleX:1,scaleY:1},0).wait(96));
